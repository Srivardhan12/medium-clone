    ...
    return (
        <div>
            ...
            <div className="flex min-w-xl max-w-5xl mx-auto ">
                ...
                <div>
                    <button disabled={btndisabled} onClick={publishBlog} className="my-7 mx-20 text-white bg-green-500 hover:bg-green-600 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Publish
                        {
