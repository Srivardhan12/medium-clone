...
// .wrangler/tmp/bundle-jDVsVQ/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "D:\\projects\\medium-clone\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// node_modules/@srivardhan_24/medium-project/dist/index.js
var require_dist = __commonJS({
  "node_modules/@srivardhan_24/medium-project/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-jDVsVQ/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-jDVsVQ/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/routes/user.ts
var import_medium_project = __toESM(require_dist());
var import_medium_project2 = __toESM(require_dist());
...
userRouter.post("/signup", async (c) => {
  try {
    ...
    const { success, error: validationError } = import_medium_project.signupInput.safeParse(body);
    if (!success) {
      c.status(401);
      return c.json({
    ...
    const token = await sign2({ id: user.id, name: user.name }, c.env.JWT_SECRET_MESSAGE);
    return c.text(token);
  } catch (error) {
    c.status(401);
...
userRouter.post("/signin", async (c) => {
  ...
  const body = await c.req.json();
  const { success } = import_medium_project2.signinInput.safeParse(body);
  if (!success) {
    c.status(401);
...
blogRouter.use("/", async (c, next) => {
  try {
    ...
    const user = await verify2(header, c.env.JWT_SECRET_MESSAGE);
    if (!user) {
      c.status(403);
      return c.json({
