...
// .wrangler/tmp/bundle-hd3R9v/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "D:\\projects\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// .wrangler/tmp/bundle-hd3R9v/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-hd3R9v/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  try {
    ...
    const token = await sign2({ id: user.id }, c.env.JWT_SECRET_MESSAGE);
    return c.text(token);
  } catch (error) {
    c.status(401);
