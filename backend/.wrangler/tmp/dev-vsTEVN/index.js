...
// .wrangler/tmp/bundle-UN4o6t/checked-fetch.js
...
// .wrangler/tmp/bundle-UN4o6t/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-UN4o6t/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signin", async (c) => {
  ...
  const token = sign2({ id: user.id }, c.env.JWT_SECRET_MESSAGE);
  return c.json({
    JWT: token
  });
});
